/*
 ...
 뒤로가기를 눌렀을 시에 전에 나왔던값 2가 나오고 또 뒤로가기 누르면 처음인 0이 나와야합니다.
 앞으로 가기누르면 2가 나오고 3이 나오도록 합니다.
...
let nex = []; // 처음에 값을 입력하고 계산하면 결과값이 순서대로 저장하는배열
let num1;
let num2;
let calcu;
let result;
...
prev.addEventListener("click", () => {
  ...
  num1.value = nex[nex.length - 1]; // nex 배열의 저장되어있는 마지막 값이 브라우저에 표시됩니디.
  result.textContent = nex[nex.length - 1]; // nex 배열의 저장되어있는 마지막 값이 브라우저에 표시됩니디.
